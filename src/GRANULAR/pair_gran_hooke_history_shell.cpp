...
#include "pair_gran_hooke_history_shell.h"
...
PairGranHookeHistoryShell::PairGranHookeHistoryShell(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 1;
  ...
  //single_extra = 10;          // by Heyi
  //svector = new double[10];   // by Heyi
  single_extra = 11;           // by Heyi
  svector = new double[11];    // by Heyi
...
PairGranHookeHistoryShell::~PairGranHookeHistoryShell()
{
  if (copymode) return;
...
void PairGranHookeHistoryShell::compute(int eflag, int vflag)
{
...
void PairGranHookeHistoryShell::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairGranHookeHistoryShell::settings(int narg, char **arg)
{
  ...
  shell = utils::numeric(FLERR,arg[6],false,lmp);
...
void PairGranHookeHistoryShell::coeff(int narg, char **arg)
{
...
void PairGranHookeHistoryShell::init_style()
{
  int i;
...
double PairGranHookeHistoryShell::init_one(int i, int j)
{
  if (!allocated) allocate();
...
void PairGranHookeHistoryShell::write_restart(FILE *fp)
{
...
void PairGranHookeHistoryShell::read_restart(FILE *fp)
{
...
void PairGranHookeHistoryShell::write_restart_settings(FILE *fp)
{
...
void PairGranHookeHistoryShell::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairGranHookeHistoryShell::reset_dt()
{
  dt = update->dt;
}
...
double PairGranHookeHistoryShell::single(int i, int j, int /*itype*/, int /*jtype*/,
                                    double rsq,
...
int PairGranHookeHistoryShell::pack_forward_comm(int n, int *list, double *buf,
...
void PairGranHookeHistoryShell::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
double PairGranHookeHistoryShell::memory_usage()
{
