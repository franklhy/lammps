...
PairStyle(gran/hooke/history/shell,PairGranHookeHistoryShell)

#else

#ifndef LMP_PAIR_GRAN_HOOKE_HISTORY_SHELL_H
#define LMP_PAIR_GRAN_HOOKE_HISTORY_SHELL_H

#include "pair.h"

namespace LAMMPS_NS {

class PairGranHookeHistoryShell : public Pair {
 public:
  PairGranHookeHistoryShell(class LAMMPS *);
  virtual ~PairGranHookeHistoryShell();
